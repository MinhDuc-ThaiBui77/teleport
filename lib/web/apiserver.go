...
func (h *Handler) bindDefaultEndpoints() {
	...
	// custom (fork) access request handlers — OSS role-based requests.
	...
	h.POST("/webapi/sites/:site/accessrequests/restore/:request_id", h.WithClusterAuth(h.restoreAccessRequest))
