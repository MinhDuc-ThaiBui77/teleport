...
import { CustomAccessRequest } from './CustomAccessRequest';
...
export class FeatureCustomAccessRequest implements TeleportFeature {
  ...
  route = {
    ...
    path: cfg.routes.customAccessRequest,
    exact: true,
    component: CustomAccessRequest,
  };
  ...
  navigationItem = {
    title: NavTitle.RequestServerAccess,
    icon: ListAddCheck,
    exact: true,
    getLink(clusterId: string) {
      return cfg.getCustomAccessRequestRoute(clusterId);
    },
    searchableTags: ['access requests', 'request', 'server access', 'ssh'],
  };
}
...
export function getOSSFeatures(): TeleportFeature[] {
  return [
    ...
    // - Identity
    new AccessRequests(),
    new FeatureCustomAccessRequest(),
    new FeatureLocks(),
    new FeatureNewLock(),
