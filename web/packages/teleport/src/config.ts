...
export const ossRoutes = {
  ...
  // custom (fork) cluster-scoped page for OSS role-based access requests
  customAccessRequest: '/web/cluster/:clusterId/request-access',
...
const cfg = {
  ...
  api: {
    ...
    // custom (fork) OSS role-based access request endpoints.
    // See lib/web/accessrequests_custom.go.
  ...
  // custom (fork) getters for the OSS role-based access request UI.
  getCustomAccessRequestRoute(clusterId: string) {
    return generatePath(cfg.routes.customAccessRequest, { clusterId });
  },

  getAccessRequestsCustomUrl(clusterId: string) {
    return generatePath(cfg.api.accessRequestsCustomPath, { clusterId });
  },
